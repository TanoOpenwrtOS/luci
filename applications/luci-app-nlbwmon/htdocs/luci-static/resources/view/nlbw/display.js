...
return view.extend({
	...
	renderHostData: function() {
		...
		for (var i = 0; i < hostData.length; i++) {
			...
			trafData.push({
				...
				label: [_("%s: %%1024.2mB").format(key), cell]
			});
		...
		this.kpi('rx-total', _('%1024.2mB').format(rx_total));
		this.kpi('tx-total', _('%1024.2mB').format(tx_total));
	...
	renderLayer7Data: function() {
		...
		for (var i = 0, c = 0; i < layer7Data.length; i++) {
			...
			rxData.push({
				value: rec.rx_bytes,
				label: [_("%s: %%1024.2mB").format(rec.layer7 || _('other')), cell]
			});
	...
	renderIPv6Data: function() {
		...
		this.kpi('ipv6-rx', _('%1024.2mB').format(rx6_total));
		this.kpi('ipv6-tx', _('%1024.2mB').format(tx6_total));
	},
	...
	renderHostDetail: function(node, tooltip) {
		...
		dom.content(tooltip, [
			...
			E('div', { 'class': 'table-wrapper' }, E('table', { 'class': 'table' }, [
		...
		var node = E([], [
			...
			E('div', [
				E('div', { 'class': 'cbi-section', 'data-tab': 'traffic', 'data-tab-title': _('Traffic Distribution') }, [
					...
					E('div', { 'class': 'table-wrapper' }, E('table', { 'class': 'table', 'id': 'host-data' }, [
						E('tr', { 'class': 'tr table-titles' }, [
				...
				E('div', { 'class': 'cbi-section', 'data-tab': 'layer7', 'data-tab-title': _('Application Protocols') }, [
					...
					E('div', { 'class': 'table-wrapper' }, E('table', { 'class': 'table', 'id': 'layer7-data' }, [
						E('tr', { 'class': 'tr table-titles' }, [
				...
				E('div', { 'class': 'cbi-section', 'data-tab': 'ipv6', 'data-tab-title': _('IPv6') }, [
					...
					E('div', { 'class': 'table-wrapper' }, E('table', { 'class': 'table', 'id': 'ipv6-data' }, [
						E('tr', { 'class': 'tr table-titles' }, [
