...
return view.extend({
	...
	render: function(data) {
		...
		o = s.taboption('basic', form.Flag, 'enabled',
			_('Enabled'), _("If service is disabled it could not be started. Neither from LuCI interface nor from console"));
		o.modalonly = true;
		o.rmempty  = false;
		o.default = '1';
		...
		o = s.taboption("timer", form.Value, "force_interval",
			_("Force Interval"),
			_("Interval to force updates send to DDNS Provider. Setting this parameter to 0 will force the script to only run once"));
		o.placeholder = "72";
		o.optional = true;
		o.modalonly = true;
		o.datatype = 'uinteger';
		...
		o = s.taboption("timer", form.Value, "retry_count",
			...
			_("On Error the script will stop execution after given number of retries. The default setting of '0' will retry infinite."));
		o.placeholder = "0";
		o.optional = true;
		o.modalonly = true;
		o.datatype = 'uinteger';
